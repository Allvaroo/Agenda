	...
	<section >
        <div onload="abrir" class="container <?php echo "$down"; ?> down ">
            <div class="col-xs-12 col-md-12">
                <h3 class="ajust">Crie a Atividade</h3>
                <?php
                    if($total != 0){
                ...
                <form action="chamado.php" method="post" name="chamado" id="chamado" oninput="ajustes(this)" >
                    <div class="form-group text-center">
                     <label for="numaquina">Selecione a prioridade:</label required> 
                        <input class="form-control" type="checkbox" id="numaquina" name="numaquina" value="URGENTE">URGENTE                        
                        <input class="form-control" type="checkbox" id="numaquina" name="numaquina" value="NORMAL">NORMAL
                     ...
                     <div  class="form-group text-center">
                    	<label for="descricao">Descreva a atividade</label requered>
                    	<textarea class="form-control" type=text id="descricao" maxlength="300" name="descricao" placeholder="Descreva a atividade aqui..." rows="5" id="comment"></textarea>
                    </div>
